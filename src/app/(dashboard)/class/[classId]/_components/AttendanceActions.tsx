...
import DeleteAttendanceAlert from "./DeleteAttendanceAlert";

type AttendanceActionsProps = {
  attendance: AttendanceResult;
};

export default function AttendanceActions({ attendance }: AttendanceActionsProps) {
